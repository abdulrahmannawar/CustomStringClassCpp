...
/* Copy assignment - update the current object with the contents of object 'rhs' through copying. */
...
/* Helper method to deallocate all memory if the ref_count is 0. i.e all objects are destroyed */
